...
description: Plan and review focused changes in the IDP IKS lab repository without overengineering. Use when Codex needs to scope docs, Port catalog, governance, demo, or agent-artifact changes, decide whether an ADR is needed, preserve MVP boundaries, and define validation before implementation.
---
